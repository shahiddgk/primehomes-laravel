              ...
              @csrf
                ...
                <div class="row">
                  ...
                  <label for="exampleInputEmail1">First Name</label>
                    <input type="text" name="firstname" value="{{old('firstname')}}" class="form-control" placeholder="Please Enter First Name" required>
                  </div>
                  <div class="col-4">
                  <label for="exampleInputEmail1">Last Name</label>
                    <input type="text" name="lastname" value="{{old('lastname')}}" class="form-control" placeholder="Please Enter Last Name" required>
                  </div>
                  <div class="col-4">
                ...
                <div class="row">
                  <div class="col-4">
                  <label for="exampleInputEmail1">Primary Email <code> Use this email as owner login & password: 123456</code></label>
                    <input type="email" name="primary_email" value="{{old('primary_email')}}" class="form-control" placeholder="Please Enter Primary Email" required>
                  </div>
                  <div class="col-4">
                ...
                <div class="row">
                  ...
                  <label for="exampleInputEmail1">Primary Mobile</label>
                    <input type="text" name="primary_mobile" value="{{old('primary_mobile')}}" class="form-control" placeholder="Please Enter Primary Mobile" required>
                  </div>
                  <div class="col-4">
                ...
                <div class="row">
                  ...
                  <div class="col-4 authorized-person" style="display:none">
                    <div class="form-group">
                      ...
                      <input type="text" name="contact_person" class="form-control" id="exampleInputEmail1" placeholder="Enter Emergency contact person name">
                    </div>
                  </div>
                  <div class="col-4 authorized-person" style="display:none">
                      <div class="form-group">
                        <label for="exampleInputEmail1">Contact Number</label>
                        <input type="text" name="contact_number" class="form-control" id="exampleInputEmail1" placeholder="Enter Emergency Cotnact Number">
                      </div>
                  </div>
                </div>
