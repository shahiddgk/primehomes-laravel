            ...
            @endif
              ...
              @method('PUT')
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="name" value="{{$amenity->name}}" class="form-control"  placeholder="Enter Amenity Name">
                </div>
              
                <div class="form-group">
                    <label for="exampleInputEmail1">Amenity Dues <code> Put 0 for free</code></label>
                    <input type="number" step=0.1 name="charges" class="form-control" value="{{$amenity->charges}}" placeholder="Enter Amenity Address">
                </div>
                <div class="form-group">
                  <label for="exampleInputEmail1">Cycle For Charges</label>
                  <select class="form-control" name="charges_cycle"  required>
                    <option value="monthly" @if($amenity->charges_cycle=='monthly') selected  @endif>Monthly</option>
                    <option value="yearly" @if($amenity->charges_cycle=='yearly') selected  @endif>Yearly</option>
